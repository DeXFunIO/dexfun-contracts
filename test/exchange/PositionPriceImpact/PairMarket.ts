...
describe("Exchange.PositionPriceImpact.PairMarket", () => {
  ...
  beforeEach(async () => {
    ...
    ({ reader, dataStore, referralStorage, ethUsdMarket, wnt } =
      fixture.contracts);
  ...
  it("price impact", async () => {
    ...
    await handleOrder(fixture, {
      ...
      execute: {
        ...
        afterExecution: ({ logs }) => {
          ...
          expect(positionIncreaseEvent.priceImpactUsd).eq(
            "-399999999999999992588018713340000"
          ); // -400
        },
      },
    });
    ...
    ).eq("79999999999999999"); // 0.079999999999999999 ETH, 400 USD
    ...
    await handleOrder(fixture, {
      ...
      execute: {
        ...
        afterExecution: ({ logs }) => {
          ...
          expect(positionIncreaseEvent.priceImpactUsd).eq(
            "-1199999999999999977764056140040000"
          ); // -1200
        },
      },
    });
    ...
    await handleOrder(fixture, {
      ...
      execute: {
        ...
        afterExecution: ({ logs }) => {
          ...
          expect(positionIncreaseEvent.priceImpactUsd).eq(
            "39500000000000000326409486835000"
          ); // 39.5
        },
      },
    });
    ...
    ).eq("312099999999999995"); // 0.312099999999999995 ETH, 1560.5 USD
    ...
    ).eq("327899999999999996"); // 0.327899999999999996 ETH, 1639.5 USD
    ...
    await handleOrder(fixture, {
      ...
      execute: {
        ...
        afterExecution: ({ logs }) => {
          ...
          expect(positionIncreaseEvent.priceImpactUsd).eq(
            "699999999999999987029032748360000"
          ); // 700
        },
      },
    });
    ...
    ).eq("187899999999999999"); // 0.187899999999999999 ETH, 939.5 USD
    ...
    await handleOrder(fixture, {
      ...
      execute: {
        ...
        afterExecution: ({ logs }) => {
          ...
          expect(positionIncreaseEvent.priceImpactUsd).eq(
            "-299999999999999994441014035010000"
          ); // -300
        },
      },
    });
    ...
    await handleOrder(fixture, {
      ...
      execute: {
        ...
        afterExecution: ({ logs }) => {
          ...
          expect(positionIncreaseEvent.priceImpactUsd).eq(
            "199999999999999996294009356670000"
          ); // 200
        },
      },
    });
    ...
    ).eq("207899999999999999"); // 0.207899999999999999 ETH, 1039.5 USD
    ...
    await handleOrder(fixture, {
      ...
      execute: {
        ...
        afterExecution: ({ logs }) => {
          ...
          expect(positionIncreaseEvent.priceImpactUsd).eq(
            "-99999999999999998147004678330000"
          ); // -100
        },
      },
    });
    ...
    ).eq("227899999999999999"); // 0.227899999999999999 ETH, 1139.5 USD
    ...
    await handleOrder(fixture, {
      ...
      execute: {
        ...
        afterExecution: ({ logs }) => {
          ...
          expect(positionDecreaseEvent.priceImpactUsd).eq(
            "49999999999999999073502339165000"
          ); // 50
        },
      },
    });
    ...
    ).eq("217899999999999999"); // 0.217899999999999999 ETH, 1089.5 USD
    ...
    ).eq("237899999999999999"); // 0.237899999999999999 ETH, 1189.5 USD
  ...
  it("capped price impact", async () => {
    ...
    await dataStore.setUint(
      keys.maxPositionImpactFactorKey(ethUsdMarket.marketToken, true),
      decimalToFloat(1, 4)
    );
  ...
  it("difference in pnl should be equal to price impact amount", async () => {
    ...
    await handleOrder(fixture, {
      ...
      execute: {
        afterExecution: ({ logs }) => {
          const positionIncreaseEvent = getEventData(logs, "PositionIncrease");
          expect(positionIncreaseEvent.executionPrice).eq("5010020040080160"); // ~5010
          expect(positionIncreaseEvent.priceImpactAmount).eq(
            "-79999999999999999"
          ); // 0.079999999999999999 ETH, 400 USD
        },
      },
    });
    ...
    await handleOrder(fixture, {
      ...
      execute: {
        afterExecution: ({ logs }) => {
          ...
          expect(positionIncreaseEvent.priceImpactAmount).eq(
            "-99999999999999999"
          ); // 0.099999999999999999 ETH, 500 USD
        },
      },
    });
    ...
    await usingResult(
      ...
      (positionInfo) => {
        ...
        expect(positionInfo.position.numbers.sizeInTokens).eq(
          "59820000000000000002"
        ); // 59.820000000000000002 ETH
        expect(positionInfo.position.numbers.sizeInUsd).eq(
          decimalToFloat(300_000)
        );
      }
    ...
    ).eq("179999999999999998"); // 0.179999999999999998 ETH, 900 USD
    ...
    await handleOrder(fixture, {
      ...
      execute: {
        afterExecution: ({ logs }) => {
          ...
          expect(positionDecreaseEvent.priceImpactUsd).eq(
            "337499999999999994450071536280000"
          ); // 337.5 USD
          expect(positionDecreaseEvent.basePnlUsd).eq(
            "-449999999999999995000000000000000"
          ); // -450
        },
      },
    });
    ...
    await usingResult(
      ...
      (positionInfo) => {
        ...
        expect(positionInfo.position.numbers.collateralAmount).eq(
          "9977499999999999999"
        ); // 9.977499999999999999 ETH
        expect(positionInfo.position.numbers.sizeInTokens).eq(
          "29910000000000000001"
        ); // 29.910000000000000001 ETH
        expect(positionInfo.position.numbers.sizeInUsd).eq(
          decimalToFloat(150_000)
        );
      }
    ...
    ).eq("112499999999999999"); // 0.179999999999999998 - 0.067499999999999999 => 0.112499999999999999 ETH, 562.5 USD
  });
});
