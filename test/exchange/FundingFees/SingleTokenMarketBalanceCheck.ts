...
describe("Exchange.FundingFees.SingleTokenMarketBalanceCheck", () => {
  ...
  beforeEach(async () => {
    ...
    ({ dataStore, ethUsdSingleTokenMarket, exchangeRouter, usdc } =
      fixture.contracts);
