...
describe("Exchange.DecreasePosition", () => {
  ...
  it("uncapped price impact", async () => {
    ...
    ).eq("799999999999999986"); // 0.799999999999999986
    ...
    ).eq("399999999999999994"); // 0.399999999999999994
    ...
    ).eq("407999999999999994"); // 0.407999999999999994 ETH
    ...
    await usingResult(
      ...
      (positionInfo) => {
        expect(positionInfo.position.numbers.collateralAmount).eq(
          expandDecimals(49_560, 6)
        );
        expect(positionInfo.position.numbers.sizeInTokens).eq(
          "35280000000000000012"
        ); // 35.28
        expect(positionInfo.position.numbers.sizeInUsd).eq(
          decimalToFloat(180_000)
        );
        expect(positionInfo.basePnlUsd).eq(
          "-3599999999999999940000000000000000"
        );
      }
    );
    ...
    await usingResult(
      ...
      ([marketTokenPrice, poolValueInfo]) => {
        ...
        expect(poolValueInfo.poolValue).eq(
          "6000000000000000000010000000000000000"
        );
      }
    );
  });
  ...
  it("capped price impact", async () => {
    ...
    ).eq("779999999999999986"); // 0.779999999999999986
    ...
    ).eq("779999999999999986"); // 0.779999999999999986 ETH
    ...
    ).eq("783999999999999986"); // 0.783999999999999986 ETH
