    ...
    await handleOrder(fixture, {
      ...
      execute: {
        ...getExecuteParams(fixture, {
          prices: [prices.usdc, prices.wnt.increased.byFiftyPercent],
        }),
      },
    });
  ...
  it("capped pnl", async () => {
    ...
    await usingResult(
      ...
      ([marketTokenPrice, poolValueInfo]) => {
        ...
        expect(poolValueInfo.poolValue).eq(
          "1750000000000000000000000000000000000"
        ); // 1,750,000
      }
    );
    ...
    await usingResult(
      ...
      ([marketTokenPrice, poolValueInfo]) => {
        ...
        expect(poolValueInfo.poolValue).eq(
          "1840000000000000000000000000000000000"
        ); // 1,840,000
      }
    );
    ...
    await usingResult(
      ...
      ([marketTokenPrice, poolValueInfo]) => {
        ...
        expect(poolValueInfo.poolValue).eq(
          "1896225000000000000000000000000000000"
        ); // 1,896,225
      }
    );
