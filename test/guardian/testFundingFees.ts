...
describe("Guardian.FundingFees", () => {
  ...
  // TODO: This is skipped for now as we will not be supported single token markets at the beginning.
  it.skip("Funding fees charged in a single token market are the same as those charged for a normal market", async () => {
  ...
  it("Funding fees match when paid in different directions", async function () {
    ...
    expect(balanceAfterUser2.sub(balanceBeforeUser2)).closeTo(
      "25920028",
      "2000"
    ); // $25.920028
    ...
    expect(balanceAfterUser0.sub(balanceBeforeUser0)).closeTo(
      "5184013800000000",
      "10000000000"
    ); // $25.920069
    ...
    expect(balanceAfterUser3.sub(balanceBeforeUser3)).closeTo(
      "5184014799999999",
      "10000000000"
    ); // $25.920073999999995
    ...
    expect(USDCBalanceAfterUser2.sub(USDCBalanceBeforeUser2)).closeTo(
      "17280025",
      10
    ); // $17.280025
