...
async function main() {
  ...
  const longTokenAmount = expandDecimals(10, 18); // 10 weth
  ...
  const params: IBaseOrderUtils.CreateOrderParamsStruct = {
    ...
    numbers: {
      ...
      triggerPrice: expandDecimals(3540, 8), // $1175.0000, WETH oraclePrecision = 8 and 4 decimals
      acceptablePrice: expandDecimals(3550, 8), // $1300
      executionFee,
      callbackGasLimit: 0,
      minOutputAmount: 0,
