...
// 4. then run e.g. WRITE=true TIMELOCK_METHOD=signalGrantRole npx hardhat run --network neoX scripts/updateRoles.ts
// 5. after the timelock delay, run WRITE=true TIMELOCK_METHOD=grantRoleAfterSignal npx hardhat run --network neoX scripts/updateRoles.ts
...
async function main() {
  ...
  const rolesToAdd = {
    neoX: [
      // {
      //   role: "ORDER_KEEPER",
      //   member: "0xc0ffee254729296a45a3885639AC7E10F9d54979",
      // },
    ],
  };
